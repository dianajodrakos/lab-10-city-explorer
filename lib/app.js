...
const { mungeLocationResponse, mungeWeatherResponse } = require ('./munge.js');
app.use(cors());
...
app.get('/weather', async(req, res) => {
  try {
    ...
    const data = await request.get('https://api.weatherbit.io/v2.0/current?lat=47.6038321&lon=-122.3300624&key=63371017e84640098d3fe14708e811b8');
